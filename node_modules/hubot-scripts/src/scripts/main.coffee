module.exports = (robot) ->
    ...
    replies = [
        ...
        "Girls with asses like mine do not talk to boys with faces like yours. -She's The Man (2006)",
        "I'm not authorized to speak to trash-tier jerks like you. You know who's not trash tier? Crystal.",
        "I'm sorry, I'm not actually interested in talking to the likes of you.",
    ]
    ...
    robot.hear /i\sthink|\sguess|\shope/i, (res) ->
        ...
        if (r > p and !recentlyCalled)
            ...
            recentlyCalled = true
    kk = [
        "My butt is so big, it broke the internet.",
        "Did someone say Ray J?",
        "I'm thinking about changing my name to Cim in support of Caitlyn.",
        "I'm tired of people hating because my hubby is more fly than theirs'.",
        "You guys have all caught up on the latest Keeping Up with the Kardashians, right?",
        "You can call me First Lady 2020.",
    ]
    ...
    brags = [
     ...
     robot.hear /\skim|kardashian/i, (res) ->
        r = Math.random()
        if (r > .8 and !recentlyCalled)
            res.send res.random kk
            recentlyCalled = true
